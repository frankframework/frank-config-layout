...
import { createText, GraphForLayers, createGraphForLayers, PASS_DIRECTION_DOWN } from 'frank-config-layout';
...
function addNode(id: string, layer: number, g: GraphForLayers): void {
  g.addNode({ id, layer, isError: false, isIntermediate: false, text: '' });
}
